...
class AlbumsViewController: UIViewController {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collection.register(CustomFourthViewCell.self, forCellWithReuseIdentifier: CustomFourthViewCell.identifire)
        collection.register(HeaderFourthSection.self, forSupplementaryViewOfKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: HeaderFourthSection.identifier)
    ...
    private func createCompositionalLayout() -> UICollectionViewCompositionalLayout {
        return UICollectionViewCompositionalLayout { (sectionNumber, env) -> NSCollectionLayoutSection? in
            ...
            case 3: return self.layoutSectionFourthViewCell()
            default:
    ...
    private func layoutSectionFourthViewCell() -> NSCollectionLayoutSection {
